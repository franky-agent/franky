...
[`v1.md`](v1.md) for the closed implementation-status table and
[`../../CHANGELOG.md`](../../CHANGELOG.md) for the per-version
history. v1 catalog items already shipped during the v1.x line:
...
forward as v2.0.0. New v2.x work is recorded in
[`../../CHANGELOG.md`](../../CHANGELOG.md); items in this file are
the open backlog and become row updates here as they ship.

Items below are eligible to be picked up. As they land, the row
moves into [`../../CHANGELOG.md`](../../CHANGELOG.md) under the
matching v2.x entry, and either (a) struck through here with a
`shipped at v2.X.Y` pointer, or (b) the row is removed once the
shipped state is reflected in the v1 implementation-status table.
...
[`docs/design/decided/v2.4-richer-web-ui.md`](../../design/decided/v2.4-richer-web-ui.md).
...
- **v2.9.0 — `.contextignore` (archived/historical paths hidden from
  ...
  ([`docs/design/2.9-documentation-speification-archive.md`](../design/2.9-documentation-speification-archive.md),
  ...
  **+9 tests; 1032 → 1041.** Files touched: `coding/gitignore.zig`,
  ...
  plan:
  [`docs/design/2.9-documentation-speification-archive.md`](../design/2.9-documentation-speification-archive.md),
  [`docs/design/v2.9-impl-plan-contextignore.md`](../design/v2.9-impl-plan-contextignore.md).
