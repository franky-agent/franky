...
| src/ai/http.zig | 🟠 101.4 | 🟢 5.3 | 🟠 19 | 🟢 2 | 🟢 0.11 | 🟢 |
...
| src/coding/config.zig | 🟢 14.9 | 🟢 5.0 | 🟢 3 | 🟢 1 | 🟢 0.33 | 🟢 |
...
| src/coding/modes/web/app.js | 🟠 115.0 | 🔴 10.5 | 🟡 11 | 🟢 2 | 🟢 0.18 | 🔴 |
| src/coding/modes/rpc.zig | 🔴 137.6 | 🟡 6.9 | 🟠 20 | 🟢 2 | 🟢 0.10 | 🟠 |
| src/coding/modes/proxy.zig | 🔴 226.7 | 🟢 5.8 | 🔴 39 | 🟢 2 | 🟢 0.05 | 🟠 |
| src/coding/modes/print.zig | 🔴 220.8 | 🟢 5.8 | 🔴 38 | 🟢 2 | 🟢 0.05 | 🟡 |
...
| src/coding/config/settings.zig | 🟢 15.5 | 🟢 5.2 | 🟢 3 | 🟢 1 | 🟢 0.33 | 🟢 |
| src/coding/config/profiles.zig | 🟢 13.8 | 🟢 4.6 | 🟢 3 | 🟢 1 | 🟢 0.33 | 🟢 |
...
- **src/coding/modes/web/app.js** — moderate hotspot. Nesting depth 28.
...
| src/ai/http.zig | src/coding/tools/bash.zig | 56% | 🔺 |
...
| settings.json | src/coding/settings.zig | 42% | 🔽 |
...
| src/coding/modes/proxy.zig | src/coding/profiles.zig | 88% | 🔺 |
...
| src/coding/modes/proxy.zig | src/ai/stream.zig | 43% | 🔽 |
| src/coding/modes/print.zig | src/coding/mod.zig | 75% | 🔺 |
...
| docs/todos/todos.md | src/coding/config.zig | 100% | 🔽 |
...
| src/coding/modes/proxy.zig | src/coding/tools/subagent.zig | 82% | ➡️ |
...
| src/ai/http.zig | src/coding/tools/grep.zig | 58% | 🔺 |
| docs/todos/todos.md | Dockerfile.sandbox | 27% | 🔽 |
| settings.json | src/coding/modes/rpc.zig | 33% | 🔽 |
...
| src/ai/http.zig | build.zig.zon | 67% | 🔺 |
...
| src/ai/http.zig | Dockerfile.sandbox | 27% | 🔺 |
...
| build.zig | Dockerfile.sandbox | 36% | 🔽 |
...
| src/coding/modes/proxy.zig | src/coding/tools/grep.zig | 50% | 🔽 |
...
| build.zig | src/ai/registry.zig | 40% | 🔺 |
...
| src/coding/modes/print.zig | src/coding/diagnostics.zig | 63% | 🔺 |
| settings.json | src/coding/tools/edit.zig | 25% | 🔺 |
...
| src/coding/modes/proxy.zig | src/coding/diagnostics.zig | 38% | 🔺 |
...
| settings.json | src/coding/modes/print.zig | 58% | 🔽 |
...
| src/coding/role.zig | src/coding/modes/rpc.zig | 80% | 🔺 |
| src/ai/stream.zig | test/agent_loop_test.zig | 50% | 🔺 |
| src/ai/http.zig | docs/spec/v2.md | 36% | 🔺 |
| build.zig | src/ai/providers/google_gemini.zig | 20% | 🔺 |
| build.zig | src/agent/loop.zig | 47% | 🔺 |
...
| src/coding/modes/proxy.zig | docs/spec/v2.md | 45% | 🔺 |
...
| src/ai/http.zig | src/coding/mod.zig | 50% | 🔺 |
| src/root.zig | README.md | 56% | 🔺 |
| src/coding/modes/proxy.zig | build.zig | 47% | 🔽 |
| src/coding/modes/proxy.zig | src/coding/role.zig | 80% | 🔺 |
...
| build.zig | src/root.zig | 41% | 🔺 |
| docs/todos/todos.md | settings.json | 75% | 🔽 |
...
| src/ai/http.zig | src/ai/stream.zig | 57% | 🔺 |
| src/coding/gitignore.zig | src/coding/tools/grep.zig | 80% | 🔽 |
| src/ai/http.zig | src/agent/types.zig | 44% | 🔺 |
| src/agent/loop.zig | franky-spec-v1.md | 33% | 🔺 |
| src/ai/http.zig | src/coding/modes/proxy.zig | 50% | ➡️ |
...
| src/ai/http.zig | src/root.zig | 56% | 🔺 |
| src/coding/auth.zig | src/coding/object_store.zig | 75% | 🔺 |
| src/coding/modes/proxy.zig | docs/design/decided/v2.17-self-restart.md | 60% | 🔽 |
...
| src/ai/http.zig | src/coding/tools/write.zig | 67% | 🔺 |
| src/ai/http.zig | test/agent_loop_test.zig | 67% | 🔺 |
...
| src/ai/http.zig | src/coding/tools/edit.zig | 38% | 🔺 |
| docs/todos/todos.md | src/coding/profiles.zig | 38% | 🔽 |
| settings.json | Dockerfile.sandbox | 27% | 🔽 |
| build.zig | src/coding/modes/interactive.zig | 47% | 🔺 |
...
| build.zig | src/ai/stream.zig | 57% | ➡️ |
...
| src/ai/http.zig | src/coding/modes/interactive.zig | 39% | 🔺 |
...
| src/coding/modes/proxy.zig | Dockerfile.sandbox | 36% | 🔽 |
...
| src/ai/http.zig | src/coding/tools/subagent.zig | 27% | 🔽 |
...
| src/ai/http.zig | src/ai/registry.zig | 70% | 🔺 |
...
| src/coding/modes/interactive.zig | src/coding/role.zig | 80% | ➡️ |
...
| src/coding/config/profiles.zig | src/coding/config/settings.zig | 100% | 🔽 |
...
| build.zig | src/coding/cli.zig | 35% | 🔺 |
| src/coding/tools/grep.zig | src/agent/proxy.zig | 38% | 🔽 |
| src/coding/modes/proxy.zig | settings.json | 67% | 🔽 |
...
| src/coding/modes/proxy.zig | src/coding/permissions.zig | 75% | 🔺 |
...
| build.zig | src/coding/tools/ls.zig | 44% | 🔺 |
| src/coding/tools/bash.zig | src/coding/tools/grep.zig | 56% | 🔺 |
| build.zig | src/ai/providers/openai_chat.zig | 29% | 🔺 |
...
| src/ai/http.zig | src/agent/agent.zig | 42% | 🔺 |
| build.zig | src/coding/mod.zig | 47% | 🔺 |
...
| settings.json | src/coding/cli.zig | 25% | 🔽 |
...
| build.zig | src/coding/tools/edit.zig | 25% | 🔺 |
...
| src/ai/http.zig | src/coding/tools/find.zig | 67% | 🔺 |
...
| src/coding/modes/print.zig | Dockerfile.sandbox | 36% | ➡️ |
...
| src/coding/modes/proxy.zig | src/coding/settings.zig | 75% | 🔽 |
...
| build.zig | src/agent/agent.zig | 42% | 🔺 |
...
| docs/todos/todos.md | src/coding/modes/interactive.zig | 38% | ➡️ |
...
| src/coding/modes/proxy.zig | src/agent/guardrails/finish_task.zig | 75% | 🔽 |
...
| src/ai/http.zig | src/coding/tools/ls.zig | 67% | 🔺 |
...
| build.zig | src/agent/types.zig | 56% | 🔺 |
| src/coding/tools/ls.zig | src/coding/tools/common.zig | 75% | 🔽 |
| src/ai/http.zig | src/coding/modes/print.zig | 61% | 🔺 |
...
| src/coding/config.zig | src/coding/modes/print.zig | 100% | 🔽 |
...
| src/ai/http.zig | src/coding/cli.zig | 33% | 🔺 |
...
| build.zig | src/coding/session.zig | 33% | 🔺 |
...
| src/coding/modes/proxy.zig | src/agent/guardrails/guardrails.zig | 80% | 🔽 |
...
| build.zig | src/coding/tools/grep.zig | 50% | ➡️ |
...
| src/ai/http.zig | src/ai/errors.zig | 50% | 🔺 |
...
| src/coding/modes/proxy.zig | src/coding/modes/web/app.js | 91% | 🔺 |
| src/coding/modes/proxy.zig | src/coding/modes/interactive.zig | 76% | 🔺 |
...
| src/ai/http.zig | docs/todos/todos.md | 22% | 🔽 |
...
| settings.json | src/coding/modes/interactive.zig | 25% | 🔽 |
...
| src/coding/modes/proxy.zig | src/coding/cli.zig | 55% | 🔺 |
...
| build.zig | src/coding/modes/print.zig | 53% | ➡️ |
...
| src/ai/http.zig | src/coding/modes/rpc.zig | 28% | 🔺 |
...
| src/coding/modes/proxy.zig | src/coding/tools/edit.zig | 44% | 🔺 |
...
| src/coding/modes/proxy.zig | src/coding/compaction.zig | 43% | 🔽 |
...
| build.zig | docs/todos/todos.md | 35% | 🔽 |
...
| src/coding/modes/print.zig | src/ai/stream.zig | 86% | ➡️ |
...
| src/coding/modes/proxy.zig | docs/todos/todos.md | 54% | 🔽 |
...
| src/coding/modes/proxy.zig | src/coding/mod.zig | 42% | 🔺 |
...
| src/ai/http.zig | src/coding/session.zig | 44% | 🔺 |
| src/ai/http.zig | build.zig | 29% | 🔺 |
...
| src/coding/modes/proxy.zig | src/coding/modes/print.zig | 62% | ➡️ |
| src/ai/http.zig | src/coding/diagnostics.zig | 38% | 🔺 |
